...
CelestialObject::CelestialObject(const vector<vector<bool>> &shape, ObjectType type, int start_row,
        ...
        right_rotation(this), left_rotation(this) {
...
void CelestialObject::handleRotations() {
    ...
    if (r1 == shape && r3 == shape) {
        ...
        this->right_rotation->original_size=this->original_size;
        ...
        this->right_rotation->original_size=this->original_size;
        this->right_rotation->right_rotation->original_size=this->original_size;
        this->right_rotation->right_rotation->right_rotation->original_size=this->original_size;
